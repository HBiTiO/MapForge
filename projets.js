const PROJECTS = [
  {
    ...
    status: "Disponible",
    details: ["Création originale HBi Mapping", "Map conçue pour Garry's Mod", "Environnement urbain et résidentiel travaillé", "Fichier VMF prévu après achat"]
  }
];

const SITE_CONFIG = { discord: "hbitio", discordDisplay: "HBiTiO", email: "mbkdodos@gmail.com" };
